...
# python -m run_retrieval --strategies RET_BM25 --debug False --report False --data_path {YOUR_DATA_PATH}

python -m run_retrieval --strategies RET_BM25 --debug False --report False --run_cnt 1
