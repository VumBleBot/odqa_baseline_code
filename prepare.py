...
from retrieval.dense import DprRetrieval, DprKobertRetrieval
...
RETRIEVER = {"TFIDF": TfidfRetrieval, "DPR": DprRetrieval, "BM25": BM25Retrieval, "DPRKOBERT": DprKobertRetrieval}
